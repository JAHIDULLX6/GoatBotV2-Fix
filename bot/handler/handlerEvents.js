...
function getRole(threadData, senderID) {
	const rootOwner = global.GoatBot.config.rootOwner || [];
	const owner = global.GoatBot.config.owner || [];
	const coOwner = global.GoatBot.config.coOwner || [];
	const creator = global.GoatBot.config.creator || [];
	const developer = global.GoatBot.config.developer || [];
	const vip = global.GoatBot.config.vip || [];
	const premium = global.GoatBot.config.premium || [];
	const moderator = global.GoatBot.config.moderator || [];
	...
	return rootOwner.includes(senderID) ? 10 :
		owner.includes(senderID) ? 9 :
		coOwner.includes(senderID) ? 8 :
		creator.includes(senderID) ? 7 :
		developer.includes(senderID) ? 6 :
		vip.includes(senderID) ? 5 :
		premium.includes(senderID) ? 4 :
		moderator.includes(senderID) ? 3 :
